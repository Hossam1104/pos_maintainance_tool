...
- POS-M01, POS-M02, and corrective checkpoints POS-M02R/POS-M02R2/POS-M02R3 are complete; `TASK.md` contains the complete POS-M03 prompt, blocked pending the early Opus Restore follow-up review and explicit owner authorization.

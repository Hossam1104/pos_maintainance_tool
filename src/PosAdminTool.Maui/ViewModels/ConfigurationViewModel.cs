    ...
    : BaseViewModel(logHub)
{
    ...
    [ObservableProperty]
    private string posExecutablePath = string.Empty;

    [ObservableProperty]
    private string posUsername = string.Empty;

    [ObservableProperty]
    private string posPassword = string.Empty;
    ...
    private void Apply(AppSettings settings)
    {
        ...
        PosExecutablePath = settings.PosExecutablePath;
        ...
        {
            Microsoft.Maui.Controls.Application.Current.UserAppTheme = settings.Theme == "DARK" ? AppTheme.Dark : AppTheme.Light;
        }
    }
    ...
    private AppSettings Read()
    {
        ...
        settings.PosExecutablePath = PosExecutablePath.Trim();
        settings.PosUsername = PosUsername.Trim();
        settings.PosPassword = PosPassword;
